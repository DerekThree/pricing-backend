...
public class EligibilityReasonConditionValueSerializer extends ValueSerializer<AttributeValue> {

	@Override
	public void serialize(AttributeValue value, JsonGenerator generator,
